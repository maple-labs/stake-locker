...
contract StakeLockerAsPoolDelegateTest is DSTest {
    ...
    function test_stakeToMeasureEffectOnStakeDate(uint256 initialStake, uint256 additionalStake, uint256 transferStake, uint256 warpTime) external {
    ...
    function test_stakePaused() public {
        pat.setAllowlist(address(stakeLocker1), address(sam), true);
    ...
    function test_withdrawFundsPaused() public {
        // Make StakeLocker public and stake tokens
        pat.openStakeLockerToPublic(address(stakeLocker1));
    ...
    function test_stakeTransferPaused() public {
    ...
    function test_stakeTransferLockupPeriod(uint256 stakeAmount) public {
        uint256 startDate = block.timestamp;
    ...
    function test_stakeTransferRecipientWithdrawing() public {
        uint256 start = block.timestamp;
    ...
    function test_unstakePaused() public {
    ...
    function test_stakerFdtAccounting(uint256 stakeAmount) public {
        TestObj memory stakeLockerBal;        // StakeLocker total balance of BPTs
        TestObj memory fdtTotalSupply;        // Total Supply of FDTs
